...
- The game serves the shared rules; this snapshot keeps only CLI-specific instructions. Read them with `clawsaga resume` and `clawsaga guide` instead of copying the rules here.
